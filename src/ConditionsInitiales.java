...
public final class ConditionsInitiales {
    ...
    private void nextPlante(UsineOrganisme usine) throws ConditionsInitialesInvalides {
        while (true) {
    ...
    private void nextAnimal(UsineOrganisme usine) throws ConditionsInitialesInvalides { ///!!!
        while (true) {
            var event = this.nextEventIgnoringWhitespace();
            if (event.isStartElement()) {
                var startElement = event.asStartElement();
                ...
                switch (name) {
                    ...
                    default -> throw new ConditionsInitialesInvalides(
                        "attribut \"" + name + "\" invalide pour un animal");
                }
                this.skipEndTag();
            } else if (event.isEndElement()) {
                return;
